...
<script>
  ...
  <?php if (!empty($_GET['status'])) {
    $status = $_GET['status'];
    if ($status == 'success') {
      echo '<script>toastr.success("Thank you for reaching out. We will get back to you within 24 hours.");</script>';
    } else {
...
<div class="gradientOfMAinBox">
  ...
  <div class="container">
    ...
    <div class="left-section">
      ...
      <p><i class="bi bi-telephone-fill"></i> 07774584477</p>
      <p><i class="bi bi-telephone-fill"></i> 07451450534</p>
      <p><i class="bi bi-envelope-fill"></i> lalandnihalautoworks@gmail.com</p>
      <!-- <p>📞 07774584477</p>
      <p>📞 0745145053</p> -->
      <!-- <p>📧 lalandnihalautoworks@gmail.com</p> -->

      <h2 class="subhead">Find Us</h2>
      <div class="map">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.3775566845634!2d79.93161297556668!3d6.845261093152959!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae251c01adc2b11%3A0x4961e51edaece264!2sLAL%20AND%20NIHAL%20AUTOWORKS!5e0!3m2!1sen!2slk!4v1741328994673!5m2!1sen!2slk" width="450" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
    </div>

    <!-- Right Section -->
    <div class="right-section">
      <h2 class="subhead">Reach Out to Us</h2>
